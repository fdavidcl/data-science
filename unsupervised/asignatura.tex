...
\titleformat{\chapter}[hang]{\Huge\bfseries\sffamily}{\thechapter\hspace{20pt}\textcolor{500}{|}\hspace{20pt}}{0pt}{\Huge\bfseries}
\titlespacing*{\chapter}{0cm}{-2em}{2em}[0pt]
...
\surroundwithmdframed[style=nth-frame]{thm}
...
\parbox[t]{\textwidth}{
  %\includegraphics{by-sa.pdf}\\[4pt]
  \raggedright % Texto alineado a la izquierda
  \sffamily\large
  {\Large Este libro se distribuye bajo una licencia CC BY-SA 4.0.}\\[4pt]
  Eres libre de distribuir y adaptar el material siempre que reconozcas a los\\
  autores originales del documento y lo distribuyas bajo la misma licencia.\\[4pt]
